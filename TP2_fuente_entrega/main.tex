...
Ver mediciones en el anexo \ref{sec:anexo}: Figuras \ref{fig:osc}, y \ref{fig:osc1}.
...
Ver en el anexo \ref{sec:anexo} las mediciones correspondientes: Figuras: \ref{fig:temp}, y \ref{fig:tension-reg}.
