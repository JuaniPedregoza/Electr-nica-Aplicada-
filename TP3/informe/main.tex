...
\begin{document}
  ...
  \input{chapters/3-diseno_teorico.tex}
  \input{chapters/4-normalizacion.tex}
  \input{chapters/5-simulacion.tex}
  \input{chapters/6-rectas_de_carga.tex}
  \input{chapters/7-pequena_senal.tex}
  \input{chapters/8-mediciones_laboratorio.tex}
