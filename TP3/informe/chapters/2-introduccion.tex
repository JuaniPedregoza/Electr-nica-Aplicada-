...
\begin{enumerate}
  ...
  \item Garantizar la estabilidad térmica del punto de reposo frente a dispersiones del parámetro $\beta$ y variaciones
  ...
  \item Normalizar los componentes calculados adoptando resistores comerciales de las series estándar (E12/E24),
  ...
  \item Contrastar de forma cuantitativa los resultados analíticos, las simulaciones y las mediciones de banco.
\end{enumerate}
